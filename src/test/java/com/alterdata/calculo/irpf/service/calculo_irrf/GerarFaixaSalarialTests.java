...
@DisplayName("Executando testes unitarios IrrfService gerarFaixaSalarial()")
public class GerarFaixaSalarialTests {
    ...
    class Faixa1 {
        ...
        void deve_retornar_Faixa1_para_valor_final_faixa1() {
            ...
            IrrfRequest irrfRequest = CriarIrrfRequest.createValidWithZeroIrrfRequest();
            irrfRequest.setSalarioMensalBruto(salarioBrutoMensal);

            calcIRRF.gerarBaseCalculo(irrfRequest);
            calcIRRF.gerarFaixaSalarial();
