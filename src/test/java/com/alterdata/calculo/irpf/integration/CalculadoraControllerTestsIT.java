...
@DisplayName("Executando testes integração CalculadoraControllerTests")
class CalculadoraControllerTestsIT {
    ...
    void calcularIRRF_deve_retornar_IrpfResponse_quando_token_valido() {
