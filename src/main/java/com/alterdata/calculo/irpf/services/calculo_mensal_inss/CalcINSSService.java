package com.alterdata.calculo.irpf.services.calculo_mensal_inss;

import com.alterdata.calculo.irpf.contants.AliquotaINSS;
...
public class CalcINSSService implements BaseMensalAliquotaINSS {
    ...
    private double sla = AliquotaINSS.value(66);
